    ...
    parts: [
      {
        ...
        explanation: {
          ...
          standard: '水轮是筒车的主体结构，由木质轮辐、X型交叉加固撑木与外圈构成。水流冲击挡水板带动水轮整体旋转，是能量转换的核心部件。',
          expert: '水轮采用辐条式结构+多层X型交叉加固撑木，轮辐外缘安装挡水木片，内缘连接厚重轮毂。其设计兼顾结构强度与转动惯量，轮径决定了提水高度（一般可达数丈）。',
        },
        modern: '水轮机转轮',
        source: '乃粒·水利',
      },
      {
        ...
        explanation: {
          ...
          standard: '外圈挡水木片是筒车接收水流冲击的窄木片，增大水流冲击推力。卡扣是托槽榫卯造型的木榫，下半托住竹筒筒身，上半卡住竹筒外壁。',
          expert: '挡水木片呈凸起窄板状，可增大水流有效作用面积并减少溅射损失，将水流动能最大化转化为转动力矩。卡扣采用传统木作托槽榫卯工艺，带倒角，牢固托住斜置竹筒。',
        },
        modern: '水轮机涡轮叶片',
        source: '乃粒·水利',
      },
      {
        ...
        explanation: {
          ...
          standard: '竹筒是筒车的提水容器，用竹子制成，40°内倾斜绑在水轮周围，筒口朝外下方。轮转至下方时入水装满，转至上方时自动倾倒出水。',
          expert: '竹筒以40°倾角斜绑于轮周卡扣上，带竹节分段纹路。其安装角度经过设计：在最低点切入水面装水，在最高点越过顶点后因重力自动倾覆排水，巧妙利用了重力与几何位置的关系。',
        },
        modern: '斗式提升机料斗',
        source: '乃粒·水利',
      },
      {
        ...
        explanation: {
          ...
          standard: '导水槽天池是紧贴水轮最高点正前方的宽浅长斜木槽，用于承接竹筒倾倒出的水，并经导流尾槽导流至农田灌溉沟渠。',
          expert: '导水槽天池位于水轮最高点正前方，由顶部加长横梁延伸支撑。槽体宽浅长斜，向右下倾斜导流，末端有导流尾槽延伸向下。竹筒越过顶点倾覆时，水落入槽中，再经导流渠送至田间。',
        },
        modern: '输水渡槽',
        source: '乃粒·水利',
      },
